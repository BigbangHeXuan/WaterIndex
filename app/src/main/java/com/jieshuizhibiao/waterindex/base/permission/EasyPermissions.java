...
import com.jieshuizhibiao.waterindex.ui.view.AlertIndexDialog;
...
public class EasyPermissions {
    ...
    private static AlertIndexDialog alertIndexDialog;
    ...
    private static void showRationaleAlertDialog(
        ...
        if (alertIndexDialog == null) {
            alertIndexDialog = new AlertIndexDialog(activity);
            alertIndexDialog.setCancelable(false);
            alertIndexDialog.builder()
                    .setTitle("申请权限")
                    .setMsg(rationale)
